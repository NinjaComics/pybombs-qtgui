...
class Ui_PrefixChooserDialog(object):
    def setupUi(self, PrefixChooserDialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(20, 80, 121, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.comboBox = QtWidgets.QComboBox(PrefixChooserDialog)
        self.comboBox.setGeometry(QtCore.QRect(20, 110, 281, 41))
        ...
        self.label_3.setGeometry(QtCore.QRect(150, 30, 151, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
